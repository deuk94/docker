...
public interface PaymentRepository extends JpaRepository<Payment, Integer> {
    ...
    // 결제 페이지 조회
    @Query("SELECT new com.ttallang.docker.user.payment.model.JoinPayment(p.customerId, p.paymentId, "
    ...
    // 포트원(결제 정보)
    @Query("SELECT new com.ttallang.docker.user.payment.model.JoinPortOne("+
